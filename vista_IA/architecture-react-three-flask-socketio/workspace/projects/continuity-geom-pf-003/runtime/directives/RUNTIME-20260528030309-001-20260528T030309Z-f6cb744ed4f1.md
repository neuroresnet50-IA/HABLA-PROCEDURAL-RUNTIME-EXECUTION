# Directive RUNTIME-20260528030309-001

- Generated at: `2026-05-28T03:03:09Z`
- Sprint: `None`
- Source hash: `f6cb744ed4f18f03b25c0ec3d55372e0e9e0eb398c7bb0d7a038998e0735557a`
- Checkpoint: `complexity-estimate`

## Worker Instruction

```text
Task: RUNTIME-20260528030309-001 - Determinar si tres longitudes pueden formar un triangulo
System root: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio
Task workspace root: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-geom-pf-003
Mandatory write root: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-geom-pf-003
Forbidden paths:
...
- /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/* except /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-geom-pf-003
...
Sprint: None -
Goal: Determinar si tres longitudes pueden formar un triangulo.; Escribe la solucion o plan en docs/geometry_case_003.md, manten el cambio pequeno, registra evidencia y no modifiques archivos no relacionados.
...
- docs/geometry_case_003.md
Expected validation:
- python3 -B -c "from pathlib import Path; missing=[p for p in ['docs/geometry_case_003.md'] if not Path(p).is_file()]; assert not missing, missing"
...
- LACE policy: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-geom-pf-003/LACE.md
- LACE log: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-geom-pf-003/LACE_LOG.md
...
- Missing required evidence before execution: docs/geometry_case_003.md
- Missing expected file: docs/geometry_case_003.md
Closure criteria:
