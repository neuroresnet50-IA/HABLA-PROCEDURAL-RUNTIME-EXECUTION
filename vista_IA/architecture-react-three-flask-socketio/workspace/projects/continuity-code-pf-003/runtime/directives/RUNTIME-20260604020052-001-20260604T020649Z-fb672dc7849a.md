# Directive RUNTIME-20260604020052-001

- Generated at: `2026-06-04T02:06:49Z`
- Sprint: `None`
- Source hash: `fb672dc7849ab31e9b0486e1e0ace76c78a904bb3710dabfc5e0bd8ad2d18f72`
- Checkpoint: `session-preparing-agent-2b8a910c8e`

## Worker Instruction

```text
Task: RUNTIME-20260604020052-001 - Crear estrategia de pruebas para una API REST
...
Starting checkpoint:
- session-preparing-agent-2b8a910c8e
Known risks or blockers:
- Blocked task RUNTIME-20260604020052-002 missing dependencies: RUNTIME-20260604020052-001
