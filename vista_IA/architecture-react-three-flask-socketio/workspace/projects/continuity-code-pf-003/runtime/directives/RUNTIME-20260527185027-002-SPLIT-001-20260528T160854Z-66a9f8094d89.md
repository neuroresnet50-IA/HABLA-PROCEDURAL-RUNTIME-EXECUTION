# Directive RUNTIME-20260527185027-002-SPLIT-001

- Generated at: `2026-05-28T16:08:54Z`
- Sprint: `None`
- Source hash: `66a9f8094d8978cbe90e32e392fb64308963ffa6658d7d804f8673b0f2f07388`
- Checkpoint: `session-preparing-agent-e1d3e10c09`

## Worker Instruction

```text
Task: RUNTIME-20260527185027-002-SPLIT-001 - Escribe la solucion o plan en docs/advanced_programming_case_003.md, manten split 1
...
Sprint: None -
Goal: Prepare smaller scope for Escribe la solucion o plan en docs/advanced_programming_case_003.md, manten el cambio pequeno, registra evidencia y no modifiques archivos no relacionados.. Reason: Failure suggests timeout or oversized task.
...
Starting checkpoint:
- session-preparing-agent-e1d3e10c09
Known risks or blockers:
- Missing required evidence before execution: docs/advanced_programming_case_003.md
- Missing expected file: docs/advanced_programming_case_003.md
- Prior failure for active task: Missing expected evidence files: docs/advanced_programming_case_003.md; Missing expected file: docs/advanced_programming_case_003.md; Validation command failed with return code 1: python3 -B -c "from pathlib import Path; missing=[p for p in ['docs/advanced_programming_case_003.md'] if not Path(p).is_file()]; assert not missing, missing"
