# Directive RUNTIME-20260529050725-001

- Generated at: `2026-05-29T05:07:25Z`
- Sprint: `None`
- Source hash: `135bdcbfb0183bd2012dc6780f704668dbbb57d4faaad7473284a43d8058515c`
- Checkpoint: `complexity-estimate`

## Worker Instruction

```text
Task: RUNTIME-20260529050725-001 - Resolver conceptualmente el movimiento de un pendulo simple
System root: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio
Task workspace root: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-mixed-pf-006
Mandatory write root: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-mixed-pf-006
Forbidden paths:
...
- /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/* except /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-mixed-pf-006
...
Sprint: None -
Goal: Resolver conceptualmente el movimiento de un pendulo simple con pequenas oscilaciones, energia mecanica y periodo aproximado.; Escribe la solucion o plan en docs/mixed_science_programming_case_006_physics.md, manten el cambio pequeno, registra evidencia, usa contenido educativo seguro y no modifiques archivos no relacionados.
...
Exact deliverables:
- docs/mixed_science_programming_case_006_physics.md
Active restrictions:
...
- docs/mixed_science_programming_case_006_physics.md
Expected validation:
- python3 -B -c "from pathlib import Path; missing=[p for p in ['docs/mixed_science_programming_case_006_physics.md'] if not Path(p).is_file()]; assert not missing, missing"
...
- LACE policy: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-mixed-pf-006/LACE.md
- LACE log: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-mixed-pf-006/LACE_LOG.md
...
- Missing required evidence before execution: docs/mixed_science_programming_case_006_physics.md
- Missing expected file: docs/mixed_science_programming_case_006_physics.md
Closure criteria:
