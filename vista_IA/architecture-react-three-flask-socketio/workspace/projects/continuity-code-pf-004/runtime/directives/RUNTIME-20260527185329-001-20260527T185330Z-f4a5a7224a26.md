# Directive RUNTIME-20260527185329-001

- Generated at: `2026-05-27T18:53:30Z`
- Sprint: `None`
- Source hash: `f4a5a7224a268df3fd0b4fc3d1153ac7d31c5ff093f795e498813281ede84ebf`
- Checkpoint: `complexity-estimate`

## Worker Instruction

```text
Task: RUNTIME-20260527185329-001 - Explicar un patron retry con backoff y causa
...
Sprint: None -
Goal: Explicar un patron retry con backoff y causa registrada por intento.; Escribe la solucion o plan en docs/advanced_programming_case_004.md, manten el cambio pequeno, registra evidencia y no modifiques archivos no relacionados.
