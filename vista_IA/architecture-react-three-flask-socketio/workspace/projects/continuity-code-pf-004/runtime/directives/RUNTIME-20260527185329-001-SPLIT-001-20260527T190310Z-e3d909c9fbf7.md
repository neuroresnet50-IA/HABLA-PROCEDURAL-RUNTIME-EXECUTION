# Directive RUNTIME-20260527185329-001-SPLIT-001

- Generated at: `2026-05-27T19:03:10Z`
- Sprint: `None`
- Source hash: `e3d909c9fbf77ddfda3a062371aa6f04710b11723dabd778d1209d39cbcb5363`
- Checkpoint: `runtime-20260527185329-001-split-001-retry-1-recovery`

## Worker Instruction

```text
Task: RUNTIME-20260527185329-001-SPLIT-001 - Explicar un patron retry con backoff y causa split 1
...
Sprint: None -
Goal: Explicar un patron retry con backoff y causa registrada por intento. Reason: Failure suggests timeout or oversized task.
...
Exact deliverables:
- docs/advanced_programming_case_004.md
Active restrictions:
...
- docs/advanced_programming_case_004.md
Expected validation:
- python3 -B -c "from pathlib import Path; missing=[p for p in ['docs/advanced_programming_case_004.md'] if not Path(p).is_file()]; assert not missing, missing"
...
Starting checkpoint:
- runtime-20260527185329-001-split-001-retry-1-recovery
Known risks or blockers:
- Missing required evidence before execution: docs/advanced_programming_case_004.md
- Missing expected file: docs/advanced_programming_case_004.md
- Prior failure for active task: Missing expected evidence files: docs/advanced_programming_case_004.md; Missing expected file: docs/advanced_programming_case_004.md; Validation command failed with return code 1: python3 -B -c "from pathlib import Path; missing=[p for p in ['docs/advanced_programming_case_004.md'] if not Path(p).is_file()]; assert not missing, missing"
Closure criteria:
