# Directive RUNTIME-20260527184656-001-SPLIT-002

- Generated at: `2026-05-27T22:21:46Z`
- Sprint: `None`
- Source hash: `b748e0e7de5299d02c565649057bda9ea8b7db43d4f3054f6fc3634af311547e`
- Checkpoint: `session-preparing-agent-c28eabee77`

## Worker Instruction

```text
Task: RUNTIME-20260527184656-001-SPLIT-002 - Refactorizar conceptualmente un modulo grande en tres capas split 2
...
Sprint: None -
Goal: Escribe la solucion o plan en docs/advanced_programming_case_002.md, manten el cambio pequeno, registra evidencia y no modifiques archivos no relacionados. Reason: Failure suggests timeout or oversized task.
...
Starting checkpoint:
- session-preparing-agent-c28eabee77
