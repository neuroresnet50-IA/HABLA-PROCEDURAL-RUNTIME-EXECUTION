# Directive RUNTIME-20260527184656-001-SPLIT-001

- Generated at: `2026-05-27T18:56:15Z`
- Sprint: `None`
- Source hash: `6f5d887c01b56487f170d149477121bd9010965547453c56168d13f1b46fd259`
- Checkpoint: `runtime-20260527184656-001-split-001-retry-1-recovery`

## Worker Instruction

```text
Task: RUNTIME-20260527184656-001-SPLIT-001 - Refactorizar conceptualmente un modulo grande en tres capas split 1
...
Sprint: None -
Goal: Refactorizar conceptualmente un modulo grande en tres capas con responsabilidades claras. Reason: Failure suggests timeout or oversized task.
...
Exact deliverables:
- docs/advanced_programming_case_002.md
Active restrictions:
...
- docs/advanced_programming_case_002.md
Expected validation:
- python3 -B -c "from pathlib import Path; missing=[p for p in ['docs/advanced_programming_case_002.md'] if not Path(p).is_file()]; assert not missing, missing"
...
Starting checkpoint:
- runtime-20260527184656-001-split-001-retry-1-recovery
Known risks or blockers:
- Missing required evidence before execution: docs/advanced_programming_case_002.md
- Missing expected file: docs/advanced_programming_case_002.md
- Prior failure for active task: Missing expected evidence files: docs/advanced_programming_case_002.md; Missing expected file: docs/advanced_programming_case_002.md; Validation command failed with return code 1: python3 -B -c "from pathlib import Path; missing=[p for p in ['docs/advanced_programming_case_002.md'] if not Path(p).is_file()]; assert not missing, missing"
Closure criteria:
