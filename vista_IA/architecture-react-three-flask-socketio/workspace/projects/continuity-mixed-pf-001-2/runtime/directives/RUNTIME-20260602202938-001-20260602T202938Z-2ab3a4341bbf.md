# Directive RUNTIME-20260602202938-001

- Generated at: `2026-06-02T20:29:38Z`
- Sprint: `None`
- Source hash: `2ab3a4341bbf49788bf44eb777335b5de147ae2e843aa108f50af00304a42080`
- Checkpoint: `complexity-estimate`

## Worker Instruction

```text
Task: RUNTIME-20260602202938-001 - Explicar un caso de caida libre desde reposo
...
- docs/mixed_science_programming_case_001_physics.md
Expected validation:
- python3 -B -c "from pathlib import Path; missing=[p for p in ['docs/mixed_science_programming_case_001_physics.md'] if not Path(p).is_file()]; assert not missing, missing"
...
- Missing required evidence before execution: docs/mixed_science_programming_case_001_physics.md
- Missing expected file: docs/mixed_science_programming_case_001_physics.md
Closure criteria:
