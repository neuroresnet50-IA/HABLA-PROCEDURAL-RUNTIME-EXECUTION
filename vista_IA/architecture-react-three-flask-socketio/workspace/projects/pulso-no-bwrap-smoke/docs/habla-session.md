...
- policyPath: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/pulso-no-bwrap-smoke/LACE.md
- logPath: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/pulso-no-bwrap-smoke/LACE_LOG.md
...
ENTRADA:
-> DEFINE pregunta_usuario COMO "Crea el archivo docs/no_bwrap_smoke.md con un resumen breve de validacion local no-bwrap. Mantén el cambio pequeno y no modifiques archivos no relacionados."
