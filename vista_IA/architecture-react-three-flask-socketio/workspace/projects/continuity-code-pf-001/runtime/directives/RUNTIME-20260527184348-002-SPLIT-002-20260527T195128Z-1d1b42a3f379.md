# Directive RUNTIME-20260527184348-002-SPLIT-002

- Generated at: `2026-05-27T19:51:28Z`
- Sprint: `None`
- Source hash: `1d1b42a3f379a08b8722ec4de4f885577246ba0217a26f716b2eb53d3f063993`
- Checkpoint: `runtime-20260527184348-002-split-002-retry-1-recovery`

## Worker Instruction

```text
Task: RUNTIME-20260527184348-002-SPLIT-002 - Escribe la solucion o plan en docs/advanced_programming_case_001.md, manten split 2
...
Sprint: None -
Goal: Complete smaller scope for Escribe la solucion o plan en docs/advanced_programming_case_001.md, manten el cambio pequeno, registra evidencia y no modifiques archivos no relacionados.. Reason: Failure suggests timeout or oversized task.
...
Starting checkpoint:
- runtime-20260527184348-002-split-002-retry-1-recovery
Known risks or blockers:
- Missing required evidence before execution: docs/advanced_programming_case_001.md
- Missing expected file: docs/advanced_programming_case_001.md
- Prior failure for active task: Missing expected evidence files: docs/advanced_programming_case_001.md; Missing expected file: docs/advanced_programming_case_001.md; Validation command failed with return code 1: python3 -B -c "from pathlib import Path; missing=[p for p in ['docs/advanced_programming_case_001.md'] if not Path(p).is_file()]; assert not missing, missing"
Closure criteria:
