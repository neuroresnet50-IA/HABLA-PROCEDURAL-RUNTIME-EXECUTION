# Directive RUNTIME-20260527190058-001

- Generated at: `2026-05-27T19:00:59Z`
- Sprint: `None`
- Source hash: `f4f3e003b24334fe6158cdc72992c8384e30bae89cb46a3c922782b2abc7c021`
- Checkpoint: `complexity-estimate`

## Worker Instruction

```text
Task: RUNTIME-20260527190058-001 - Crear pseudocodigo para procesar eventos JSONL idempotentes.; Escribe
System root: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio
Task workspace root: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-code-pf-006
Mandatory write root: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-code-pf-006
Forbidden paths:
...
- /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/* except /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-code-pf-006
...
Sprint: None -
Goal: Crear pseudocodigo para procesar eventos JSONL idempotentes.; Escribe la solucion o plan en docs/advanced_programming_case_006.md, manten el cambio pequeno, registra evidencia y no modifiques archivos no relacionados.
Complejidad operativa:
- Dificultad: Facil
- Score: 18 | confianza: 88
...
Exact deliverables:
- docs/advanced_programming_case_006.md
Active restrictions:
...
- docs/advanced_programming_case_006.md
Expected validation:
- python3 -B -c "from pathlib import Path; missing=[p for p in ['docs/advanced_programming_case_006.md'] if not Path(p).is_file()]; assert not missing, missing"
...
- LACE policy: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-code-pf-006/LACE.md
- LACE log: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-code-pf-006/LACE_LOG.md
...
- Missing required evidence before execution: docs/advanced_programming_case_006.md
- Missing expected file: docs/advanced_programming_case_006.md
Closure criteria:
