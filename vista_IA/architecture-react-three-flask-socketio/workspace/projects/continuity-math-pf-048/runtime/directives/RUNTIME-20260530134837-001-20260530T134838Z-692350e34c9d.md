# Directive RUNTIME-20260530134837-001

- Generated at: `2026-05-30T13:48:38Z`
- Sprint: `None`
- Source hash: `692350e34c9da246bd7854d6cde42c793667d9b41f7b67e01a23600d8a4ba4fa`
- Checkpoint: `complexity-estimate`

## Worker Instruction

```text
Task: RUNTIME-20260530134837-001 - Crear un validador textual para una solucion matematica
System root: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio
Task workspace root: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-math-pf-048
Mandatory write root: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-math-pf-048
Forbidden paths:
...
- /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/* except /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-math-pf-048
...
Sprint: None -
Goal: Crear un validador textual para una solucion matematica paso a paso.; Escribe la solucion o plan en docs/mathematics_case_048.md, manten el cambio pequeno, registra evidencia y no modifiques archivos no relacionados.
...
- docs/mathematics_case_048.md
Expected validation:
- python3 -B -c "from pathlib import Path; missing=[p for p in ['docs/mathematics_case_048.md'] if not Path(p).is_file()]; assert not missing, missing"
...
- LACE policy: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-math-pf-048/LACE.md
- LACE log: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-math-pf-048/LACE_LOG.md
...
- Missing required evidence before execution: docs/mathematics_case_048.md
- Missing expected file: docs/mathematics_case_048.md
Closure criteria:
