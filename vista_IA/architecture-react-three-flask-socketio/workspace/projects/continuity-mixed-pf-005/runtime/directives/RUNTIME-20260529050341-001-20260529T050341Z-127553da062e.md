# Directive RUNTIME-20260529050341-001

- Generated at: `2026-05-29T05:03:41Z`
- Sprint: `None`
- Source hash: `127553da062e9030778be2f5cf01c4d3132911a0d061b3fb022f936ac02780f8`
- Checkpoint: `complexity-estimate`

## Worker Instruction

```text
Task: RUNTIME-20260529050341-001 - Explicar el uso de Henderson-Hasselbalch para estimar el
System root: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio
Task workspace root: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-mixed-pf-005
Mandatory write root: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-mixed-pf-005
Forbidden paths:
...
- /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/* except /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-mixed-pf-005
...
Sprint: None -
Goal: Explicar el uso de Henderson-Hasselbalch para estimar el pH de un buffer acido-base, indicando limites del modelo y chequeos de consistencia.; Escribe la solucion o plan en docs/mixed_science_programming_case_005_chemistry.md, manten el cambio pequeno, registra evidencia, usa contenido educativo seguro y no modifiques archivos no relacionados.
...
Exact deliverables:
- docs/mixed_science_programming_case_005_chemistry.md
Active restrictions:
...
- docs/mixed_science_programming_case_005_chemistry.md
Expected validation:
- python3 -B -c "from pathlib import Path; missing=[p for p in ['docs/mixed_science_programming_case_005_chemistry.md'] if not Path(p).is_file()]; assert not missing, missing"
...
- LACE policy: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-mixed-pf-005/LACE.md
- LACE log: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-mixed-pf-005/LACE_LOG.md
...
- Missing required evidence before execution: docs/mixed_science_programming_case_005_chemistry.md
- Missing expected file: docs/mixed_science_programming_case_005_chemistry.md
Closure criteria:
