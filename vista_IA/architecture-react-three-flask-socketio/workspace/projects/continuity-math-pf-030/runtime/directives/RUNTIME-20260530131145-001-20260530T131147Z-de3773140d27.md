# Directive RUNTIME-20260530131145-001

- Generated at: `2026-05-30T13:11:47Z`
- Sprint: `None`
- Source hash: `de3773140d2743dd1a6cd429c2e2368f874253103d3e3b6270d0c716998eea4f`
- Checkpoint: `complexity-estimate`

## Worker Instruction

```text
Task: RUNTIME-20260530131145-001 - Detectar un error comun en una demostracion algebraica
System root: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio
Task workspace root: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-math-pf-030
Mandatory write root: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-math-pf-030
Forbidden paths:
...
- /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/* except /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-math-pf-030
...
Sprint: None -
Goal: Detectar un error comun en una demostracion algebraica y corregirlo.; Escribe la solucion o plan en docs/mathematics_case_030.md, manten el cambio pequeno, registra evidencia y no modifiques archivos no relacionados.
...
- docs/mathematics_case_030.md
Expected validation:
- python3 -B -c "from pathlib import Path; missing=[p for p in ['docs/mathematics_case_030.md'] if not Path(p).is_file()]; assert not missing, missing"
...
- LACE policy: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-math-pf-030/LACE.md
- LACE log: /home/neurodriver/BASE _METACOGNICION_COLOMBIA/vista_IA/architecture-react-three-flask-socketio/workspace/projects/continuity-math-pf-030/LACE_LOG.md
...
- Missing required evidence before execution: docs/mathematics_case_030.md
- Missing expected file: docs/mathematics_case_030.md
Closure criteria:
