# Directive RUNTIME-20260601005556-001

- Generated at: `2026-06-01T00:55:56Z`
- Sprint: `None`
- Source hash: `550c5405bace2778eb07dbce52f62b5fae27130e1a8a45e57dff6e8b05fa75e6`
- Checkpoint: `complexity-estimate`

## Worker Instruction

```text
Task: RUNTIME-20260601005556-001 - Build runnable static web app
...
Sprint: None -
Goal: desarrollenun juego 3D de mario bros con toda la logica de tableros scores el juego debe de ser autonomo controlado por IA y un agente DQN APRENDIZAJE PO REFUERZO CON RECONPENZA Y CASTILLO CREEEN NUEVAS COSA QUE HAGAN EL JUEGO MAS EMOCIONANTE
Complejidad operativa:
- Dificultad: Dificil
- Score: 50 | confianza: 83
- Agentes recomendados: 4 de max 8
- Ciclos LACE recomendados: 5 (min 2 / max 10)
- Presupuesto: 18 tareas, 1800s timeout, 3 retries
- Herramientas requeridas: integrity, sandbox, scanner
Exact deliverables:
- frontend/index.html
- frontend/styles.css
- frontend/app.js
