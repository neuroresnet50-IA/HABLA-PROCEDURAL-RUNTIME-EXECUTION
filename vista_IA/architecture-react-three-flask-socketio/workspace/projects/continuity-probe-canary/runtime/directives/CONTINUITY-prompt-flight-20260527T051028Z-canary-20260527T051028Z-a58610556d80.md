# Directive CONTINUITY-prompt-flight-20260527T051028Z-canary

- Generated at: `2026-05-27T05:10:28Z`
- Sprint: `None`
- Source hash: `a58610556d80ed453804572dda63674e45ecf614a6dfd5d2ce7e08ff84dbf722`
- Checkpoint: `prompt-flight-prompt-flight-20260527T050907Z`

## Worker Instruction

```text
Task: CONTINUITY-prompt-flight-20260527T051028Z-canary - Continuity probe canary task
...
- src/continuity_probe.txt
Expected validation:
- python3 -B -c 'from pathlib import Path; text=Path('"'"'src/continuity_probe.txt'"'"').read_text(encoding='"'"'utf-8'"'"'); assert '"'"'traceId=prompt-flight-20260527T051028Z-canary'"'"' in text; assert '"'"'status=worker_executed'"'"' in text'
