# Directive CONTINUITY-20260527T050739Z

- Generated at: `2026-05-27T05:07:40Z`
- Sprint: `None`
- Source hash: `a34a3b6fe45133242727728a43b365e6163f341d4b12838b371b1a8c953cd360`
- Checkpoint: `prompt-flight-prompt-flight-20260527T050508Z`

## Worker Instruction

```text
Task: CONTINUITY-20260527T050739Z - Continuity probe canary task
...
- src/continuity_probe.txt
Expected validation:
- python3 -B -c 'from pathlib import Path; text=Path('"'"'src/continuity_probe.txt'"'"').read_text(encoding='"'"'utf-8'"'"'); assert '"'"'traceId=continuity-20260527T050739Z'"'"' in text; assert '"'"'status=worker_executed'"'"' in text'
