# Directive CONTINUITY-20260527T030026Z

- Generated at: `2026-05-27T03:00:26Z`
- Sprint: `None`
- Source hash: `22b4bca02cf896cfda18ce3bfbe76f766b8be70aeb5b0e7ef3ea8da6f74bcfbd`
- Checkpoint: `continuity-continuity-local-debug`

## Worker Instruction

```text
Task: CONTINUITY-20260527T030026Z - Continuity probe canary task
...
- src/continuity_probe.txt
Expected validation:
- python3 -B -c 'from pathlib import Path; text=Path('"'"'src/continuity_probe.txt'"'"').read_text(encoding='"'"'utf-8'"'"'); assert '"'"'traceId=continuity-20260527T030026Z'"'"' in text; assert '"'"'status=worker_executed'"'"' in text'
