# Directive CONTINUITY-20260527T030336Z

- Generated at: `2026-05-27T03:03:38Z`
- Sprint: `None`
- Source hash: `10cc7ddb63db76133780709c2d1ff488be56a257348d44aca7ad99008a88908d`
- Checkpoint: `continuity-continuity-local-debug`

## Worker Instruction

```text
Task: CONTINUITY-20260527T030336Z - Continuity probe canary task
...
- src/continuity_probe.txt
Expected validation:
- python3 -B -c 'from pathlib import Path; text=Path('"'"'src/continuity_probe.txt'"'"').read_text(encoding='"'"'utf-8'"'"'); assert '"'"'traceId=continuity-20260527T030336Z'"'"' in text; assert '"'"'status=worker_executed'"'"' in text'
