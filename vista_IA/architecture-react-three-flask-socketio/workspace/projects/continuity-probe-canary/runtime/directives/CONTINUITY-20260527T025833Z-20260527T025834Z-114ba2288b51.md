# Directive CONTINUITY-20260527T025833Z

- Generated at: `2026-05-27T02:58:34Z`
- Sprint: `None`
- Source hash: `114ba2288b51931394139d67f0ab68c223679f5050dde371595ec22a34ba4595`
- Checkpoint: `none`

## Worker Instruction

```text
Task: CONTINUITY-20260527T025833Z - Continuity probe canary task
...
- src/continuity_probe.txt
Expected validation:
- python3 -B -c 'from pathlib import Path; text=Path('"'"'src/continuity_probe.txt'"'"').read_text(encoding='"'"'utf-8'"'"'); assert '"'"'traceId=continuity-20260527T025833Z'"'"' in text; assert '"'"'status=worker_executed'"'"' in text'
