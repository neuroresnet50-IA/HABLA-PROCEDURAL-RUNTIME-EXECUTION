# Directive CONTINUITY-20260527T050723Z

- Generated at: `2026-05-27T05:07:23Z`
- Sprint: `None`
- Source hash: `7f96e103af8f7cd2cb37ab129f9599a0778bbe0824384189d60fcf2586bf3d84`
- Checkpoint: `prompt-flight-prompt-flight-20260527T050508Z`

## Worker Instruction

```text
Task: CONTINUITY-20260527T050723Z - Continuity probe canary task
...
- src/continuity_probe.txt
Expected validation:
- python3 -B -c 'from pathlib import Path; text=Path('"'"'src/continuity_probe.txt'"'"').read_text(encoding='"'"'utf-8'"'"'); assert '"'"'traceId=continuity-20260527T050723Z'"'"' in text; assert '"'"'status=worker_executed'"'"' in text'
