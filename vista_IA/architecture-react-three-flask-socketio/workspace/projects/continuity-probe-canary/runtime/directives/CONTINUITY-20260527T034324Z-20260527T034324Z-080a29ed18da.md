# Directive CONTINUITY-20260527T034324Z

- Generated at: `2026-05-27T03:43:24Z`
- Sprint: `None`
- Source hash: `080a29ed18daca986c1a8c7f294411d66c5603a1d8eead4417279676cc54f5c4`
- Checkpoint: `continuity-prompt-flight-20260527T033816Z-canary`

## Worker Instruction

```text
Task: CONTINUITY-20260527T034324Z - Continuity probe canary task
...
- src/continuity_probe.txt
Expected validation:
- python3 -B -c 'from pathlib import Path; text=Path('"'"'src/continuity_probe.txt'"'"').read_text(encoding='"'"'utf-8'"'"'); assert '"'"'traceId=continuity-20260527T034324Z'"'"' in text; assert '"'"'status=worker_executed'"'"' in text'
