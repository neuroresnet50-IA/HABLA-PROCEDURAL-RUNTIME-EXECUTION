# Directive RUNTIME-20260527073638-001-SPLIT-001

- Generated at: `2026-05-27T14:24:42Z`
- Sprint: `None`
- Source hash: `6b736a10991218d671c5ded6aca9b868617683253e33338498f07195df2bd009`
- Checkpoint: `runtime-20260527073638-001-split-001-retry-1-recovery`

## Worker Instruction

```text
Task: RUNTIME-20260527073638-001-SPLIT-001 - Implementar AGENTS.md split 1
...
Starting checkpoint:
- runtime-20260527073638-001-split-001-retry-1-recovery
...
- Prior failure for active task: Missing expected evidence files: AGENTS.md; Missing expected file: AGENTS.md; Validation command failed with return code 1: python3 -B -c "from pathlib import Path; missing=[p for p in ['AGENTS.md'] if not Path(p).is_file()]; assert not missing, missing"
Closure criteria:
