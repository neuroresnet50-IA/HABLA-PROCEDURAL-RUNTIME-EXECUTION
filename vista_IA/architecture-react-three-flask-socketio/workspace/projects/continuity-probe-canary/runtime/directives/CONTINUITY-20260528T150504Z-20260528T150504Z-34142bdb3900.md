# Directive CONTINUITY-20260528T150504Z

- Generated at: `2026-05-28T15:05:04Z`
- Sprint: `None`
- Source hash: `34142bdb3900f351e55be4da34a4f001a4d7d423bebb609b5fa9ff73882c4e3a`
- Checkpoint: `session-preparing-agent-efe67ccb8a`

## Worker Instruction

```text
Task: CONTINUITY-20260528T150504Z - Continuity probe canary task
...
- src/continuity_probe.txt
Expected validation:
- python3 -B -c 'from pathlib import Path; text=Path('"'"'src/continuity_probe.txt'"'"').read_text(encoding='"'"'utf-8'"'"'); assert '"'"'traceId=continuity-20260528T150504Z'"'"' in text; assert '"'"'status=worker_executed'"'"' in text'
...
Starting checkpoint:
- session-preparing-agent-efe67ccb8a
