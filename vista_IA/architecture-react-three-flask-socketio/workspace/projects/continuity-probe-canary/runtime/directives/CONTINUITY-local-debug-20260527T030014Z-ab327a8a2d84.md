# Directive CONTINUITY-local-debug

- Generated at: `2026-05-27T03:00:14Z`
- Sprint: `None`
- Source hash: `ab327a8a2d848510b2cc6de461000c52e7fc16d2bab06f58221f95c1df6806d6`
- Checkpoint: `continuity-continuity-20260527T025833Z`

## Worker Instruction

```text
Task: CONTINUITY-local-debug - Continuity probe canary task
...
- src/continuity_probe.txt
Expected validation:
- python3 -B -c 'from pathlib import Path; text=Path('"'"'src/continuity_probe.txt'"'"').read_text(encoding='"'"'utf-8'"'"'); assert '"'"'traceId=continuity-local-debug'"'"' in text; assert '"'"'status=worker_executed'"'"' in text'
...
Starting checkpoint:
- continuity-continuity-20260527T025833Z
Known risks or blockers:
- Missing required evidence before execution: src/continuity_probe.txt
- Missing expected file: src/continuity_probe.txt
Closure criteria:
