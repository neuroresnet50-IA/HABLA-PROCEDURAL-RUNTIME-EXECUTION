# Directive CONTINUITY-prompt-flight-20260527T051104Z-canary

- Generated at: `2026-05-27T05:11:10Z`
- Sprint: `None`
- Source hash: `64dc9b93d018be861b63461941a4731e2d04aaf4d35cc8d6c49f60d789ea822e`
- Checkpoint: `prompt-flight-prompt-flight-20260527T050907Z`

## Worker Instruction

```text
Task: CONTINUITY-prompt-flight-20260527T051104Z-canary - Continuity probe canary task
...
- src/continuity_probe.txt
Expected validation:
- python3 -B -c 'from pathlib import Path; text=Path('"'"'src/continuity_probe.txt'"'"').read_text(encoding='"'"'utf-8'"'"'); assert '"'"'traceId=prompt-flight-20260527T051104Z-canary'"'"' in text; assert '"'"'status=worker_executed'"'"' in text'
