# Directive CONTINUITY-20260527T031130Z

- Generated at: `2026-05-27T03:11:30Z`
- Sprint: `None`
- Source hash: `d30bad850bf8c7aa93a0e558039c7a676c4f1f53f6936be4af0f01009afae8d2`
- Checkpoint: `continuity-continuity-local-debug`

## Worker Instruction

```text
Task: CONTINUITY-20260527T031130Z - Continuity probe canary task
...
- src/continuity_probe.txt
Expected validation:
- python3 -B -c 'from pathlib import Path; text=Path('"'"'src/continuity_probe.txt'"'"').read_text(encoding='"'"'utf-8'"'"'); assert '"'"'traceId=continuity-20260527T031130Z'"'"' in text; assert '"'"'status=worker_executed'"'"' in text'
