# Directive CONTINUITY-prompt-flight-20260527T034342Z-canary

- Generated at: `2026-05-27T03:43:42Z`
- Sprint: `None`
- Source hash: `949a0a2e25d5c60dd4cb468a1a95eb107f21a34137352e189207cf960223c46b`
- Checkpoint: `continuity-prompt-flight-20260527T033816Z-canary`

## Worker Instruction

```text
Task: CONTINUITY-prompt-flight-20260527T034342Z-canary - Continuity probe canary task
...
- src/continuity_probe.txt
Expected validation:
- python3 -B -c 'from pathlib import Path; text=Path('"'"'src/continuity_probe.txt'"'"').read_text(encoding='"'"'utf-8'"'"'); assert '"'"'traceId=prompt-flight-20260527T034342Z-canary'"'"' in text; assert '"'"'status=worker_executed'"'"' in text'
...
Starting checkpoint:
- continuity-prompt-flight-20260527T033816Z-canary
