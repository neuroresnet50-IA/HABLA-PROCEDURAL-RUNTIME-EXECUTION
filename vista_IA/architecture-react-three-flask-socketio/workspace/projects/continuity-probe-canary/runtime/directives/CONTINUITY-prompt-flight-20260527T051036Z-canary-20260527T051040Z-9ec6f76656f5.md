# Directive CONTINUITY-prompt-flight-20260527T051036Z-canary

- Generated at: `2026-05-27T05:10:40Z`
- Sprint: `None`
- Source hash: `9ec6f76656f5a601fe776da028d8d4508ed8df367db4db4f5637e993159928e0`
- Checkpoint: `prompt-flight-prompt-flight-20260527T050907Z`

## Worker Instruction

```text
Task: CONTINUITY-prompt-flight-20260527T051036Z-canary - Continuity probe canary task
...
- src/continuity_probe.txt
Expected validation:
- python3 -B -c 'from pathlib import Path; text=Path('"'"'src/continuity_probe.txt'"'"').read_text(encoding='"'"'utf-8'"'"'); assert '"'"'traceId=prompt-flight-20260527T051036Z-canary'"'"' in text; assert '"'"'status=worker_executed'"'"' in text'
