# Directive CONTINUITY-prompt-flight-20260527T050759Z-canary

- Generated at: `2026-05-27T05:07:59Z`
- Sprint: `None`
- Source hash: `540e8a26d487fb7b824e6945de6b48ac8102b5edabb6e39f689efbeb372cd9f6`
- Checkpoint: `prompt-flight-prompt-flight-20260527T050508Z`

## Worker Instruction

```text
Task: CONTINUITY-prompt-flight-20260527T050759Z-canary - Continuity probe canary task
...
- src/continuity_probe.txt
Expected validation:
- python3 -B -c 'from pathlib import Path; text=Path('"'"'src/continuity_probe.txt'"'"').read_text(encoding='"'"'utf-8'"'"'); assert '"'"'traceId=prompt-flight-20260527T050759Z-canary'"'"' in text; assert '"'"'status=worker_executed'"'"' in text'
