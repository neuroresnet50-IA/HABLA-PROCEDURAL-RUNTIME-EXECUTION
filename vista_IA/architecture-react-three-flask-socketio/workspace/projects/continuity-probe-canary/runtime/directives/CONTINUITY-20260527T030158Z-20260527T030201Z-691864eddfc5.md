# Directive CONTINUITY-20260527T030158Z

- Generated at: `2026-05-27T03:02:01Z`
- Sprint: `None`
- Source hash: `691864eddfc56f6e87bd69a29e19ed587adcdf061482b5c94513a09c4c0bd278`
- Checkpoint: `continuity-continuity-local-debug`

## Worker Instruction

```text
Task: CONTINUITY-20260527T030158Z - Continuity probe canary task
...
- src/continuity_probe.txt
Expected validation:
- python3 -B -c 'from pathlib import Path; text=Path('"'"'src/continuity_probe.txt'"'"').read_text(encoding='"'"'utf-8'"'"'); assert '"'"'traceId=continuity-20260527T030158Z'"'"' in text; assert '"'"'status=worker_executed'"'"' in text'
