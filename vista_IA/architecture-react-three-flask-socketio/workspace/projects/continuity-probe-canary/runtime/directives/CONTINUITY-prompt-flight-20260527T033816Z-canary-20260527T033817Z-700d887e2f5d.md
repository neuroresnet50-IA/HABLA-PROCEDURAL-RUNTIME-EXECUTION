# Directive CONTINUITY-prompt-flight-20260527T033816Z-canary

- Generated at: `2026-05-27T03:38:17Z`
- Sprint: `None`
- Source hash: `700d887e2f5d01b5c49654bb55574f356790c71425113e60811d6a2c70b705a4`
- Checkpoint: `continuity-continuity-local-debug`

## Worker Instruction

```text
Task: CONTINUITY-prompt-flight-20260527T033816Z-canary - Continuity probe canary task
...
- src/continuity_probe.txt
Expected validation:
- python3 -B -c 'from pathlib import Path; text=Path('"'"'src/continuity_probe.txt'"'"').read_text(encoding='"'"'utf-8'"'"'); assert '"'"'traceId=prompt-flight-20260527T033816Z-canary'"'"' in text; assert '"'"'status=worker_executed'"'"' in text'
...
Starting checkpoint:
- continuity-continuity-local-debug
