...
Validacion smoke de runtime HABLA/Codex: abrir archivos del proyecto y reportar estado sin modificar archivos; terminar con causa concreta.
...
ENTRADA:
-> DEFINE pregunta_usuario COMO "Validacion smoke de runtime HABLA/Codex: abrir archivos del proyecto y reportar estado sin modificar archivos; terminar con causa concreta."
