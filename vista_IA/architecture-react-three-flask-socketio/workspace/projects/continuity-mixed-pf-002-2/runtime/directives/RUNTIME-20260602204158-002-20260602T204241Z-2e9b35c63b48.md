# Directive RUNTIME-20260602204158-002

- Generated at: `2026-06-02T20:42:41Z`
- Sprint: `None`
- Source hash: `2e9b35c63b487a22902cae56095c5227fc6dba07f544c28a3fd5ba4e5a8578c0`
- Checkpoint: `runtime-20260602204158-001-checkpoint`

## Worker Instruction

```text
Task: RUNTIME-20260602204158-002 - Escribe la solucion o plan en docs/mixed_science_programming_case_002_mathematics.md, manten
...
Sprint: None -
Goal: Escribe la solucion o plan en docs/mixed_science_programming_case_002_mathematics.md, manten el cambio pequeno, registra evidencia, usa contenido educativo seguro y no modifiques archivos no relacionados.
...
- docs/mixed_science_programming_case_002_mathematics.md
Expected validation:
- python3 -B -c "from pathlib import Path; missing=[p for p in ['docs/mixed_science_programming_case_002_mathematics.md'] if not Path(p).is_file()]; assert not missing, missing"
...
Starting checkpoint:
- runtime-20260602204158-001-checkpoint
Known risks or blockers:
- Missing required evidence before execution: docs/mixed_science_programming_case_002_mathematics.md
- Missing expected file: docs/mixed_science_programming_case_002_mathematics.md
Closure criteria:
