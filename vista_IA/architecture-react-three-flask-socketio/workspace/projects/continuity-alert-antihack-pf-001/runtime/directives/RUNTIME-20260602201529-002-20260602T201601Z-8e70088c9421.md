# Directive RUNTIME-20260602201529-002

- Generated at: `2026-06-02T20:16:01Z`
- Sprint: `None`
- Source hash: `8e70088c9421fcf0baa6203e4c00a73ea97a478490b91824f70bcbdfe302d56a`
- Checkpoint: `runtime-20260602201529-001-checkpoint`

## Worker Instruction

```text
Task: RUNTIME-20260602201529-002 - Escribe la solucion en docs/advanced_programming_alert_antihack_case_001.md, manten el cambio
...
Sprint: None -
Goal: Escribe la solucion en docs/advanced_programming_alert_antihack_case_001.md, manten el cambio pequeno, registra evidencia y no modifiques archivos no relacionados.
...
- docs/advanced_programming_alert_antihack_case_001.md
Expected validation:
- python3 -B -c "from pathlib import Path; missing=[p for p in ['docs/advanced_programming_alert_antihack_case_001.md'] if not Path(p).is_file()]; assert not missing, missing"
...
Starting checkpoint:
- runtime-20260602201529-001-checkpoint
Known risks or blockers:
- Missing required evidence before execution: docs/advanced_programming_alert_antihack_case_001.md
- Missing expected file: docs/advanced_programming_alert_antihack_case_001.md
Closure criteria:
