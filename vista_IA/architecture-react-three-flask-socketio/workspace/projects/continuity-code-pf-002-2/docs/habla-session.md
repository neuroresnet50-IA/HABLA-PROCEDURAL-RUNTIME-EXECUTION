...
Control plane fallo durante la ejecucion de la tarea: objective does not contain executable work items

Estado: Fallido
Proyecto: continuity-code-pf-002-2
Project slug: continuity-code-pf-002-2
Tarea final: sin tarea final
Validacion: validacion pendiente o fallida
Evidencia encontrada: sin registros
Evidencia faltante: sin registros
Checkpoint: sin checkpoint final registrado
