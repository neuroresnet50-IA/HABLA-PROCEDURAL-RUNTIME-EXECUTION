# Directive REPAIR-20260519210000-SPLIT-005

- Generated at: `2026-05-19T21:02:47Z`
- Sprint: `None`
- Source hash: `080ee7ed424da822859dd5441703f5b6a527b463a44346d95b16a0e3a04b0856`
- Checkpoint: `repair-20260519210000-split-004-checkpoint`

## Worker Instruction

```text
Task: REPAIR-20260519210000-SPLIT-005 - Reparar punto rojo en docs/habla-session.md split 5
...
Sprint: None - 
Goal: Produce expected file runtime/artifacts/agent_file_manifest.seal.json. Reason: Failure suggests timeout or oversized task.
Exact deliverables:
- frontend/app.js
- frontend/index.html
- frontend/styles.css
...
Starting checkpoint:
- repair-20260519210000-split-004-checkpoint
