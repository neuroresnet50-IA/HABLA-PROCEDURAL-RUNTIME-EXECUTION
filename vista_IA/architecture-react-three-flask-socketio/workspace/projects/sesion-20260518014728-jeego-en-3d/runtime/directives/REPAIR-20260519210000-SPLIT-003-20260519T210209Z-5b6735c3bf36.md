# Directive REPAIR-20260519210000-SPLIT-003

- Generated at: `2026-05-19T21:02:09Z`
- Sprint: `None`
- Source hash: `5b6735c3bf369dbe12a2d4b16881ee78881a83b606001391324e605d5eb313e4`
- Checkpoint: `repair-20260519210000-split-002-checkpoint`

## Worker Instruction

```text
Task: REPAIR-20260519210000-SPLIT-003 - Reparar punto rojo en docs/habla-session.md split 3
...
Sprint: None - 
Goal: Produce expected file frontend/styles.css. Reason: Failure suggests timeout or oversized task.
Exact deliverables:
- frontend/styles.css
Active restrictions:
...
- frontend/styles.css
Expected validation:
- python3 -B -c "from pathlib import Path; missing=[p for p in ['frontend/styles.css'] if not Path(p).is_file()]; assert not missing, missing"
...
Starting checkpoint:
- repair-20260519210000-split-002-checkpoint
