# Directive REPAIR-20260518072331-SPLIT-002

- Generated at: `2026-05-18T07:38:47Z`
- Sprint: `None`
- Source hash: `f184677ae288c7073016e7fd799df288b3fe3191e2a35064de9c22b25df0dafb`
- Checkpoint: `repair-20260518072331-checkpoint`

## Worker Instruction

```text
Task: REPAIR-20260518072331-SPLIT-002 - Reparar punto rojo en frontend/index.html split 2
...
Sprint: None - 
Goal: Continua el proyecto existente. No crees un proyecto nuevo y no cambies de workspace. Reason: Failure suggests timeout or oversized task.
Exact deliverables:
- frontend/index.html
Active restrictions:
...
Starting checkpoint:
- repair-20260518072331-checkpoint
