# Directive REPAIR-20260519210000-SPLIT-001

- Generated at: `2026-05-19T21:01:36Z`
- Sprint: `None`
- Source hash: `57ed2f0827245017834ddd02859f79f0d24c8462bf8b68e6977f4ce5781ebb27`
- Checkpoint: `repair-20260519210000-retry-0-recovery`

## Worker Instruction

```text
Task: REPAIR-20260519210000-SPLIT-001 - Reparar punto rojo en docs/habla-session.md split 1
...
Sprint: None - 
Goal: Produce expected file frontend/app.js. Reason: Failure suggests timeout or oversized task.
Exact deliverables:
- frontend/app.js
Active restrictions:
...
- frontend/app.js
Expected validation:
- python3 -B -c "from pathlib import Path; missing=[p for p in ['frontend/app.js'] if not Path(p).is_file()]; assert not missing, missing"
...
Starting checkpoint:
- repair-20260519210000-retry-0-recovery
