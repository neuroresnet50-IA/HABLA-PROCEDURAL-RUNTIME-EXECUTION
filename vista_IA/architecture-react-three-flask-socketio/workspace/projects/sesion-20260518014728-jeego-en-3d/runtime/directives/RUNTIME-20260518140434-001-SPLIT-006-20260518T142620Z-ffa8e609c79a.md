# Directive RUNTIME-20260518140434-001-SPLIT-006

- Generated at: `2026-05-18T14:26:20Z`
- Sprint: `None`
- Source hash: `ffa8e609c79a5ddf56d174c8d8d09e135fdb86690fafbaad74e764ac56b60b53`
- Checkpoint: `runtime-20260518140434-001-split-005-checkpoint`

## Worker Instruction

```text
Task: RUNTIME-20260518140434-001-SPLIT-006 - sesion-20260518014728 JEEGO EN 3D workspace/projects/sesion-20260518014728-jeego-en-3d 243 archivos detectados split 6
...
Sprint: None - 
Goal: Produce expected file runtime/sandbox.json. Reason: Failure suggests timeout or oversized task.
Exact deliverables:
...
- runtime/sandbox.json
Expected validation:
- python3 -B -c "from pathlib import Path; missing=[p for p in ['runtime/sandbox.json'] if not Path(p).is_file()]; assert not missing, missing"
...
Starting checkpoint:
- runtime-20260518140434-001-split-005-checkpoint
