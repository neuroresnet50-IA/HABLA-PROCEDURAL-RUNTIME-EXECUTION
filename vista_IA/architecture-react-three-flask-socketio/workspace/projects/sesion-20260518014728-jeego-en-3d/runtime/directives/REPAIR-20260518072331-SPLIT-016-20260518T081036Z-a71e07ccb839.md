# Directive REPAIR-20260518072331-SPLIT-016

- Generated at: `2026-05-18T08:10:36Z`
- Sprint: `None`
- Source hash: `a71e07ccb8397245712db92db61d1b2012cdfee041857011345955cdfd4fa4f0`
- Checkpoint: `repair-20260518072331-split-015-checkpoint`

## Worker Instruction

```text
Task: REPAIR-20260518072331-SPLIT-016 - Reparar punto rojo en frontend/index.html split 16
...
Sprint: None - 
Goal: - Usa el bridge visual: phase antes de trabajar, focus-node sobre el archivo, sync-file despues de cada archivo escrito. Reason: Failure suggests timeout or oversized task.
Exact deliverables:
- frontend/index.html
Active restrictions:
...
Starting checkpoint:
- repair-20260518072331-split-015-checkpoint
