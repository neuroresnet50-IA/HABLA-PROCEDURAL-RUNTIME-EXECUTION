...
- Sprint: `10`
- Source hash: `4cd3894322c2d89b39028328564e944f5c6270232b48d545d6521f055e217de3`
- Checkpoint: `none`

## Worker Instruction

```text
Task: LONG-001 - Complete long project phase 1
...
Goal: Advance long project through isolated phase 1.
Exact deliverables:
...
- docs/phase-1.md
Expected validation:
- python3 -B -c "from pathlib import Path; missing=[p for p in ['docs/phase-1.md'] if not Path(p).is_file()]; assert not missing, missing"
- python3 -B -c "from pathlib import Path; text=Path('docs/phase-1.md').read_text(encoding='utf-8'); assert 'phase 1' in text, 'phase 1'"
...
- Missing required evidence before execution: docs/phase-1.md
- Missing expected file: docs/phase-1.md
- Blocked task LONG-002 missing dependencies: LONG-001
- Blocked task LONG-003 missing dependencies: LONG-002
