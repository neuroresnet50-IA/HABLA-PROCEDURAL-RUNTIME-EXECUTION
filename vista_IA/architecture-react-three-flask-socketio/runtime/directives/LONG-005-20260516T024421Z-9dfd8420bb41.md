...
- Sprint: `10`
- Source hash: `9dfd8420bb417a03abe57f1eaede7e640d8097d117027b4cfdf439c7e6210f6c`
- Checkpoint: `long-004-checkpoint`

## Worker Instruction

```text
Task: LONG-005 - Complete long project phase 5
...
Goal: Advance long project through isolated phase 5.
Exact deliverables:
...
- docs/phase-5.md
Expected validation:
- python3 -B -c "from pathlib import Path; missing=[p for p in ['docs/phase-5.md'] if not Path(p).is_file()]; assert not missing, missing"
- python3 -B -c "from pathlib import Path; text=Path('docs/phase-5.md').read_text(encoding='utf-8'); assert 'phase 5' in text, 'phase 5'"
...
- Missing required evidence before execution: docs/phase-5.md
- Missing expected file: docs/phase-5.md
Closure criteria:
