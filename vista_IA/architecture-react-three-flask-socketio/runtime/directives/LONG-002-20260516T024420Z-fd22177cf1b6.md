...
- Generated at: `2026-05-16T02:44:20Z`
- Sprint: `10`
- Source hash: `fd22177cf1b60052fded37f0e9f1dbb6cec0b12eb50f478c19f338bf01b7011d`
- Checkpoint: `long-001-checkpoint`

## Worker Instruction

```text
Task: LONG-002 - Complete long project phase 2
...
Goal: Advance long project through isolated phase 2.
Exact deliverables:
...
- docs/phase-2.md
Expected validation:
- python3 -B -c "from pathlib import Path; missing=[p for p in ['docs/phase-2.md'] if not Path(p).is_file()]; assert not missing, missing"
- python3 -B -c "from pathlib import Path; text=Path('docs/phase-2.md').read_text(encoding='utf-8'); assert 'phase 2' in text, 'phase 2'"
...
- Missing required evidence before execution: docs/phase-2.md
- Missing expected file: docs/phase-2.md
