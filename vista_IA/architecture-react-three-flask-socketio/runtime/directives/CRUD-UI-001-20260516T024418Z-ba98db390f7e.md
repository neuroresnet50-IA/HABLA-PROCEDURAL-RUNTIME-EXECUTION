# Directive CRUD-UI-001

- Generated at: `2026-05-16T02:44:18Z`
- Sprint: `10`
- Source hash: `ba98db390f7e8dbb4ce4feb8597279dd6342e69aa9424dd806a8da1f16400f9e`
- Checkpoint: `none`

## Worker Instruction

```text
Task: CRUD-UI-001 - Create HTML shell
...
Goal: Create the first UI artifact.
Exact deliverables:
...
- python3 -B -c "from pathlib import Path; text=Path('frontend/index.html').read_text(encoding='utf-8'); assert '<main' in text, '<main'"
...
- Blocked task CRUD-UI-002 missing dependencies: CRUD-UI-001
