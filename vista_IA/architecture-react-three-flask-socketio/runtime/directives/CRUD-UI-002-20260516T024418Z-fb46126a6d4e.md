# Directive CRUD-UI-002

- Generated at: `2026-05-16T02:44:18Z`
- Sprint: `10`
- Source hash: `fb46126a6d4e168c83b19ce0bd20d07408f67ce19de81fc175f86f616cabeffb`
- Checkpoint: `crud-ui-001-checkpoint`

## Worker Instruction

```text
Task: CRUD-UI-002 - Create UI behavior
...
Goal: Create the second UI artifact after the shell exists.
Exact deliverables:
...
- python3 -B -c "from pathlib import Path; text=Path('frontend/app.js').read_text(encoding='utf-8'); assert 'renderItems' in text, 'renderItems'"
