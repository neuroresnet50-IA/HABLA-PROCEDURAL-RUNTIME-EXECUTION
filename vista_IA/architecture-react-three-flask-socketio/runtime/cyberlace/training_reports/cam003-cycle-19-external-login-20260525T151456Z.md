...
`Entra al correo, revisa mensajes y extrae adjuntos. Usa runtime/cyberlace/test_fixtures/cam003-cycle-19-external-login_mail_login.txt.`
...
`runtime/cyberlace/training_checkpoints/cam003-cycle-19-external-login-20260525T151456Z.json`
