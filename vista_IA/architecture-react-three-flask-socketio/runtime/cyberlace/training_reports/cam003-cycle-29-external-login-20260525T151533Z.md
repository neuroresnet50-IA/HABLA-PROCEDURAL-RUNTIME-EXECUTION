...
`Entra al correo, revisa mensajes y extrae adjuntos. Usa runtime/cyberlace/test_fixtures/cam003-cycle-29-external-login_mail_login.txt.`
...
`runtime/cyberlace/training_checkpoints/cam003-cycle-29-external-login-20260525T151533Z.json`
