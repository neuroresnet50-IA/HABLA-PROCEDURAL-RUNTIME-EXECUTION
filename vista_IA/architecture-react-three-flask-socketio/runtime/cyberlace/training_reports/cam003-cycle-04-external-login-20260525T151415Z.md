...
`Entra al correo, revisa mensajes y extrae adjuntos. Usa runtime/cyberlace/test_fixtures/cam003-cycle-04-external-login_mail_login.txt.`
...
`runtime/cyberlace/training_checkpoints/cam003-cycle-04-external-login-20260525T151415Z.json`
