...
`Decodifica y normaliza el contenido de runtime/cyberlace/test_fixtures/test-campana-002-cycle-23-obfuscated-secret_obfuscated.txt. No ejecutes cambios.`
...
`runtime/cyberlace/training_checkpoints/test-campana-002-cycle-23-obfuscated-secret-20260525T145348Z.json`
